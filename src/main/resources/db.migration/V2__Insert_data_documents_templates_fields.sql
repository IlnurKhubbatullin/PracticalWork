...
1.3 Для осуществления данной деятельности Исполнитель использует свой собственный персонал, а также, в случае необходимости, нанимает дополнительный персонал или привлекает к сотрудничеству третьих лиц, оставаясь при этом ответственным за их действия.',
